...
$dashboard_link = ($role === 'admin') ? '../admin/index.php' : '../dashboard/dashboard_warga.php';
?>

<div class="sidebar p-3 d-flex flex-column" style="width: 260px; min-height: 100vh;">
    
    <div class="text-center mt-3 mb-5">
        <?php $logo_path = '../assets/images/logo-lampung.png'; ?>
    ...
    <ul class="nav flex-column gap-2">
        <li class="nav-item">
            <a href="<?php echo $dashboard_link; ?>" class="nav-link d-flex align-items-center <?php echo in_array($current_page, ['dashboard_warga.php', 'index.php']) ? 'active' : ''; ?>">
        ...
        <?php if ($role == 'warga'): ?>
            ...
            <li class="nav-item">
                <a href="../pengaduan/pengaduan_form.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'pengaduan_form.php' ? 'active' : ''; ?>">
                    <i class="fas fa-bullhorn me-3"></i> Lapor Jalan/Sampah
                </a>
            </li>
            <li class="nav-item">
                <a href="../pengaduan/pengaduan_riwayat.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'pengaduan_riwayat.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="../umkm/daftar_umkm.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'daftar_umkm.php' ? 'active' : ''; ?>">
                    <i class="fas fa-store me-3"></i> Daftar UMKM
                </a>
            </li>
            <li class="nav-item">
                <a href="../umkm/umkm_status.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'umkm_status.php' ? 'active' : ''; ?>">
            ...
            <li class="nav-item">
                <a href="../profile/profile.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'profile.php' ? 'active' : ''; ?>">
        ...
        <?php elseif ($role == 'admin'): ?>
            ...
            <li class="nav-item">
                <a href="../pengaduan/admin_pengaduan.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'admin_pengaduan.php' ? 'active' : ''; ?>">
                    <i class="fas fa-check-double me-3"></i> Validasi Laporan
                </a>
            </li>
            <li class="nav-item">
                <a href="../umkm/admin_umkm.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'admin_umkm.php' ? 'active' : ''; ?>">
                    <i class="fas fa-user-check me-3"></i> Validasi UMKM
                </a>
            </li>
            <li class="nav-item">
                <a href="../admin/kelola_user.php" class="nav-link d-flex align-items-center <?php echo $current_page == 'kelola_user.php' ? 'active' : ''; ?>">
